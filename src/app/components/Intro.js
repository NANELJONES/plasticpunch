  ...
  return (
    ...
    <div className='h-auto   lg:p-20 p-10 gap-10  justify-between lg:flex-row items-start max-w-[1500px] mx-auto flex-col   max-h-fit flex items-center  '>
     ...
     className='w-full lg:w-1/2 self-start  z-[2]  lg:sticky lg:top-[50px] lg:mt-[10em] '>
             <motion.h5 className='text-primary_color  ' 
              initial={{ opacity: 0, y: -30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 1.2, delay:0.5 }}
             >We are</motion.h5>

            <motion.h1 className='text-primary_color  ' 
              initial={{ opacity: 0, y: -30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 1.2, delay:0.5 }}
            ...
            className='text-primary_color   w-full'>An NGO based in Ghana promoting circular economy and environmental preservation, particularly marine conservation, to support sustainable development impacting future generations. 
</motion.h6>
...
<motion.h6 
            ...
            <br/>
            <Link href={"/aboutUs"}><button className='border-2 border-primary_color w-2/3 max-w-[200px] bg-none  text-primary_color  rounded-full'>Learn More</button></Link>
            <br/>
            <br/>
            <h4>Our Numbers</h4>
            <br/>
  ...
  <div className="w-full">
    ...
    >
      <img src="/Us/1.jpg" className="w-full h-auto object-cover md:max-h-[300px]" />
      <img src="/Us/2.jpg" className="w-full h-auto object-cover md:max-h-[300px]" />
      <img src="/Us/3.jpeg" className="w-full h-auto object-cover  md:max-h-[300px]" />
      <img src="/Us/4.jpeg" className="w-full h-auto object-cover mmd:max-h-[300px]" />
      <img src="/Us/4.jpeg" className="w-full h-auto object-cover  md:max-h-[300px]" />
      <img src="/Us/4.jpeg" className="w-full h-auto object-cover  md:max-h-[300px]" />
    </motion.div>
  </div>
</div>
