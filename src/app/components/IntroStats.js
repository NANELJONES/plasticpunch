...
const IntroStat1 = () => {
  return (
    <div className=" mx-auto w-full  relative p-8 bg-[rgba(256,256,256,0.6)] flex items-center shadow-md md:backdrop-blur-md md::backdrop-none md:shadow-none md::bg-none">
...
const IntroStats2 = () => {
    return (
      <div className=" mx-auto  relative p-8 bg-[rgba(256,256,256,0.6)] flex items-center shadow-md md:backdrop-blur-md md::backdrop-none md:shadow-none md::bg-none">
